...
import { resetPassword, resetPasswordWithToken, getSecurityQuestions } from '../lib/auth';
  ...
  const resetMutation = useMutation({
    mutationFn: (data) => {
      return token
        ...
        : resetPassword(data.newPassword, data.securityQuestion, data.securityAnswer);
    },
    onSuccess: () => {
      if (token) {
